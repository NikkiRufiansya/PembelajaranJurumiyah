package com.khil.pembelajaranjurumiyah.dialog;
...
public class WrongDialog {
    ...
    public void wrongDialog(String getAnswerNr,final QuizActivity quizActivity){
        ...
        textViewCorrectAnswer.setText("Correct Ans: " + String.valueOf(getAnswerNr));
