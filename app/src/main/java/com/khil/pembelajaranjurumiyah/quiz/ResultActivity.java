...
public class ResultActivity extends AppCompatActivity {
    ...
    TextView txtHighScore, txtStatus;
    TextView txtTotalQuizQues,txtCorrectQues,txtWrongQues;

    Button btStartQuiz, btMainMenu, btNextQuiz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btNextQuiz = findViewById(R.id.result_bt_nextplay);
        ...
        btNextQuiz.setOnClickListener(v -> {
            int nextNomorMateri = nomorMateri + 1;
            Intent intent = new Intent(ResultActivity.this, MateriActivity.class);
            intent.putExtra("nomorMateri", nextNomorMateri);
            startActivity(intent);
        });
        ...
        txtTotalQuizQues.setText("Total Quiz: " + String.valueOf(totalQuestion));
        txtCorrectQues.setText("Benar: " + String.valueOf(correctQues));
        txtWrongQues.setText("Salah: " + String.valueOf(wrongQues));

        if (correctQues >= 7){
            txtStatus.setText("Anda Berhasil");
            btStartQuiz.setVisibility(View.GONE);
            btNextQuiz.setVisibility(View.VISIBLE);
        }else{
            txtStatus.setText("Anda Gagal Silahkan Coba Lagi");
            btNextQuiz.setVisibility(View.GONE);
