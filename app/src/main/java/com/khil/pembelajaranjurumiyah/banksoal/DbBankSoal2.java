...
public class DbBankSoal2 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "banksoal2.db";
    private static final int DATBASE_VERSION = 2;

    private SQLiteDatabase db;

    public DbBankSoal2(Context context) {
    ...
    private void bankSoalMateri() {
        ...
        TambahPertanyaan(q1);
        Questions q2 = new Questions("1 + 2 = ?", "1", "2", "3", "4", 3, 1);
        TambahPertanyaan(q2);
        Questions q3 = new Questions("1 + 3 = ?", "1", "2", "3", "4", 4, 1);
        TambahPertanyaan(q3);
        Questions q4 = new Questions("1 + 4 = ?", "4", "5", "6", "7", 2, 2);
        TambahPertanyaan(q4);
        Questions q5 = new Questions("1 + 5 = ?", "4", "5", "6", "7", 3, 2);
        TambahPertanyaan(q5);
        Questions q6 = new Questions("1 + 6 = ?", "4", "5", "6", "7", 4, 2);
        TambahPertanyaan(q6);
    }
